...
(function () {
  ...
  /* ------------------------------------------------------------------ *
   * 2. Header bekommt beim Scrollen Hintergrund + Schatten
   * ------------------------------------------------------------------ */
