 ...
 *
 * Dadurch lässt sich die Seite als EINZELNE Datei ansehen (auch ohne Server,
...
html = html.replace(
  ...
  `<a href="https://www.google.com/maps/search/?api=1&query=Schlo%C3%9Fteichstra%C3%9Fe%201%2C%2009113%20Chemnitz" target="_blank" rel="noopener" class="flex h-64 w-full flex-col items-center justify-center gap-2 rounded-2xl bg-sage-100 text-center text-sage-700 shadow-card">
    ...
    <span class="font-semibold">Google-Maps-Karte</span>
    <span class="text-sm">Schloßteichstraße 1, 09113 Chemnitz</span>
...
// 6. Hinweis-Banner
const banner = `
  <div style="position:fixed;left:0;right:0;bottom:0;z-index:200;background:#2A2A28;color:#F7F2EA;font:14px/1.4 Inter,system-ui,sans-serif;padding:10px 16px;text-align:center">
